...
class VideoInfo {
  ...
  static VideoInfo fromMap(Map<String, dynamic> map) {
    return VideoInfo(
      ...
      uploaderName:
          map.containsKey('uploaderName') ? map['uploaderName'] : null,
      uploaderAvatars: map.containsKey('uploaderAvatars')
      ...
      viewCount:
          map.containsKey('viewCount') ? int.parse(map['viewCount']) : null,
      likeCount:
          map.containsKey('likeCount') ? int.parse(map['likeCount']) : null,
      dislikeCount: map.containsKey('dislikeCount')
      ...
      thumbnails: map.containsKey('thumbnails')
          ? List<String>.from(map['thumbnails'])
          : null,
    );
  }
  ...
  ChannelInfoItem getChannel() {
    return ChannelInfoItem(
        uploaderUrl, uploaderName, '', uploaderAvatars, null, -1);
  }
}
