...
import 'package:social_flow_data_extracter/extractors/playlist.dart';
import 'package:social_flow_data_extracter/models/playlist.dart';
...
class PlaylistInfoItem {
  ...
  PlaylistInfoItem(this.url, this.name, this.uploaderName, this.thumbnails,
      this.streamCount);
  ...
  static PlaylistInfoItem fromMap(Map<dynamic, dynamic> map) {
    return PlaylistInfoItem(map['url'], map['name'], map['uploaderName'],
        map['thumbnails'], int.parse(map['streamCount']));
  }
