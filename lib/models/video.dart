import 'package:social_flow_data_extracter/exceptions/stream_is_null.dart';
import 'package:social_flow_data_extracter/extractors/videos.dart';
import 'package:social_flow_data_extracter/models/infoItems/video.dart';
import 'package:social_flow_data_extracter/models/streamSegment.dart';
import 'package:social_flow_data_extracter/models/streams/audioOnlyStream.dart';
import 'package:social_flow_data_extracter/models/streams/videoOnlyStream.dart';
import 'package:social_flow_data_extracter/models/streams/videoStream.dart';
...
class YoutubeVideo {
  ...
  AudioOnlyStream? get audioWithBestAacQuality {
    ...
    if (newList.isEmpty) return audioWithHighestQuality;
    AudioOnlyStream? audio;
